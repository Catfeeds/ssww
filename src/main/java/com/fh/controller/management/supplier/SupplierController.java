package com.fh.controller.management.supplier;
...
public class SupplierController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("management/supplier/supplier_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("management/supplier/supplier_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var5", varOList.get(i).getString("FADDRESS"));	    //5
			vpd.put("var6", varOList.get(i).getString("FCONTACT"));	    //6
			vpd.put("var7", varOList.get(i).getString("FTELEPHONE"));	    //7
			vpd.put("var8", varOList.get(i).getString("FERPCODE"));	    //8
			vpd.put("var9", varOList.get(i).getString("FMODIFYTIME"));	    //9
			vpd.put("var10", varOList.get(i).getString("FNOTE"));	    //10
			varList.add(vpd);
		}
