...
import com.fh.qy.pojo.message.send.Article;
import com.fh.qy.pojo.message.send.FileMessage;
import com.fh.qy.pojo.message.send.ImgMessage;
import com.fh.qy.pojo.message.send.Media;
import com.fh.qy.pojo.message.send.News;
import com.fh.qy.pojo.message.send.NewsMessage;
import com.fh.qy.pojo.message.send.Text;
import com.fh.qy.pojo.message.send.TextMessage;
import com.fh.qy.pojo.message.send.Textcard;
import com.fh.qy.pojo.message.send.TextcardMessage;
import com.fh.qy.pojo.message.send.Video;
import com.fh.qy.pojo.message.send.VideoMessage;
import com.fh.qy.pojo.message.send.VoiceMessage;
import com.fh.qy.qyutil.WeiXinParamesUtil;
import com.fh.qy.qyutil.WeiXinUtil;
import com.fh.qy.service.SendMessageService;
...
public class SendMessageTest {
	...
	public void testSendTextMessage(){
		//0.设置消息内容
		String content="测试向特定成员发送信息！！";

		//1.创建文本消息对象
		TextMessage message=new TextMessage();
		//1.1非必需
		message.setTouser("DengJiaCheng|ZhangDeFei");  //不区分大小写
	...
	public void testSendTextcardMessage(){
		//0.设置消息内容
		String title="测试卡片信息";
		String description="<div class=\"gray\">201X年X月1X日</div> <div class=\"normal\">" +
		...
		//1.1非必需
		message.setTouser("DengJiaCheng");  //不区分大小写
