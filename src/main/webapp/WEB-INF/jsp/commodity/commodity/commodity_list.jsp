								...
								<td>
									<div class="nav-search">
										商品代码:  <span class="input-icon">
											<input type="text" placeholder="按商品代码进行搜索" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords" value="${pd.keywords }" placeholder="这里输入关键词"/>
								...
								<td>
									<div class="nav-search">
										商品名称:  <span class="input-icon">
											<input type="text" placeholder="按商品名称进行搜索" class="nav-search-input" id="nav-search-input" autocomplete="off" name="keywords1" value="${pd.keywords1 }" placeholder="这里输入关键词"/>
											<i class="ace-icon fa fa-search nav-search-icon"></i>
										</span>
									</div>
								</td>
							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											<td class='center'>
												<label class="pos-rel"><input type='checkbox' name='ids' value="${var.COMMODITY_ID}" class="ace" /><span class="lbl"></span></label>
											</td>
											...
											<td class='center'><a class='btn btn-xs btn-info' onclick="previewPic('${var.COMMODITY_ID}');">预览封面图片</a></td>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.edit == 1 }">
													<a class="btn btn-xs btn-success" title="编辑" onclick="edit('${var.COMMODITY_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.edit == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="edit('${var.COMMODITY_ID}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
															...
															<c:if test="${QX.del == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="del('${var.COMMODITY_ID}');" class="tooltip-error" data-rel="tooltip" title="删除">
																	<span class="red">
