	...
	<script type="text/javascript">
        ...
        $(function(){  
            $.ajax({  
                ...
                type:'POST',  
                //dataType:"String",  
                url:'<%=basePath%>classify_item/dateTree',
		...
		var setting = {
			...
			callback : {
				/*onClick : function(event, treeId, treeNode, clickFlag) {
					...
					if(treeNode.id == 1){
						keywords ="";
						$("#treeFrame").attr("src","<%=basePath%>itembase/list?treeKey="+treeKey);
					}
					$("#treeFrame").attr("src","<%=basePath%>itembase/list?treeKey="+treeKey);
				...
				onClick : function(event, treeId, treeNode, clickFlag) {
					...
					if (!treeNode.isParent) {
						...
						$("#treeFrame").attr("src","<%=basePath%>itembase/list?treeName="+treeName);
						return;
					}
					//var treeKey = encodeURI(encodeURI(treeNode.name));
					var treeKey = treeNode.id;
