		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="icpoorderpicpath/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="ICPOORDERPICPATH_ID" id="ICPOORDERPICPATH_ID" value="${pd.ICPOORDERPICPATH_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="FPICPATH" id="FPICPATH" value="${pd.FPICPATH}" maxlength="255" placeholder="这里输入图片路径" title="图片路径" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">描述:</td>
								<td><input type="text" name="FNOTE" id="FNOTE" value="${pd.FNOTE}" maxlength="255" placeholder="这里输入描述" title="描述" style="width:98%;"/></td>
							</tr>
							<tr>
