...
<body class="no-skin">
				...
				<div class="page-content">
					...
					<div class="row">
						...
						<div class="col-xs-12">
							...
							<input type="hidden" name="SOTEMPLATEENTRY_IDs" id="SOTEMPLATEENTRY_IDs" />
							...
							<table class="table table-border table-bg table-bordered">
								<tbody>
									<tr class="warning">
										...
										<th width="20%"><input type="text" style="width: 150px" 
									...
									<tr class="active">
										...
										<th  ><input type="text" style="width: 150px"  readonly="readonly"
							...
							<table style="width:100%;margin-left: 10px">
								<tr>
									<td style="vertical-align:top;">
										<a class="btn btn-mini btn-danger" onclick="add();">新增模板物料</a>
									</td>
								</tr>
							</table>
							<br>
	...
	<script type="text/javascript">
		...
		function saveInfo(){
            ...
            var jsoncopy = '[';
            $("#simple-tbody tr").each(function(){ 
					 if($(this).css("display")!="none"){
					 	jsoncopy += '{';
					 	jsoncopy += '"id":"' +$(this).attr("id");
					 	jsoncopy += '"}';
                 		jsoncopy += ','; 
					 }
				}
            );
            jsoncopy = jsoncopy.substring(0, jsoncopy.length - 1);  
            jsoncopy += ']';  
            $("#SOTEMPLATEENTRY_IDs").val(jsoncopy);
			//alert($("#SOTEMPLATEENTRY_IDs").val());
			$("#Form").submit();
		}
		
		
		
	function del(SOTEMPLATEENTRY_ID){
		$("#"+SOTEMPLATEENTRY_ID).css("display","none");
	}
