				...
				<div class="row">
					...
					<form action="sotemplate/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">模板编号:</td>
								<td><input type="text" name="FBILLNO" id="FBILLNO" value="${pd.FBILLNO}" maxlength="255" placeholder="这里输入模板编号" title="模板编号" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input class="span10 date-picker" name="FDATE" id="FDATE" value="${pd.FDATE}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="制作日期" title="制作日期" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">审批日期:</td>
								<td><input class="span10 date-picker" name="FCHECKDATE" id="FCHECKDATE" value="${pd.FCHECKDATE}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="审批日期" title="审批日期" style="width:98%;"/></td>
							</tr>
							<tr>
