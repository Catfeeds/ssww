...
<!--<section data-page="6" class="m-page m-page6 hide" data-id="25511" data-type="multi_contact" style="height: 643px;">
    ...
    <div  style="position: absolute;" id="container1"  >
...
<script language=javascript>
    ...
    wx.ready(function(){
        ...
        var lineLink = '<%=basePath%>test1/goThe1';   //同样，必须是绝对路径
    ...
    function getType(val){
        if( $(val).val() == "女方"){
            ...
            $(val).find("option[name='男方']").attr("selected","false");
            $("#container").css("display","none");
            $("#container1").css("display","");

        }else {
            $(val).find("option[name='男方']").attr("selected","selected");
            $(val).find("option[name='女方']").attr("selected","false");
